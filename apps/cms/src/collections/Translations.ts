  ...
  fields: [
    {
      ...
      unique: true,
      admin: {
        description: 'Translation key using dot notation (e.g., "HomePage.title" or "common.submit")',
      },
    ...
    },
    {
      ...
      admin: {
        description: 'Tags for filtering and organizing translations (e.g., "landing-page", "checkout", "navigation")',
      },
    },
  ],
}
